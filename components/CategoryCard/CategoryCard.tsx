...
export const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <Link
      href={href}
      className="group relative w-full h-[450px] rounded-2xl overflow-hidden block bg-neutral-900"
    >
      {/* --- SKELETON LOADER --- */}
      {!isMediaLoaded && (
        <div className="absolute inset-0 z-10 overflow-hidden bg-neutral-800">
          {/* базовий пульсуючий градієнт-фон */}
          ...
          {/* рухомий діагональний відблиск (GPU transform, не background-position) */}
          <div
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-black/50 transition-colors duration-500 group-hover:bg-black/70 z-15"></div>
